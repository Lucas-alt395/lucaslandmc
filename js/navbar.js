...
class LLNavbar extends HTMLElement {
    connectedCallback() {
        ...
        <nav class="topbar">
            <div class="logo-area">
                <a href="/" style="text-decoration: none;"><h1>BAPI</h1></a>
                <p class="tagline">the game linking platform</p>
            </div>
            <div class="nav-links">
                <a href="/login/login.html" class="light-text">Login</a>
                <a href="/login/signup.html" class="btn-signup">Signup</a>
            </div>
        </nav>
        `;
    }
    ...
    connectedCallback() {
        ...
        <footer class="ll-footer">
            <div class="footer-content">
                ...
                <p class="disclaimer">
                    BAPI is an independent game linking platform. 
                    <strong>Roblox</strong> and <strong>Blox</strong> are trademarks of Roblox Corporation. 
                    This site is not affiliated with, authorized, or endorsed by Roblox Corp.
                </p>
                <p class="disclaimer">
